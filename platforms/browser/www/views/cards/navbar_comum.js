...
var navbar_comum_v_ondemand = `
    <nav class="nav-extended default-bg-color-black"> 
        <div class="nav-wrapper">
            <div class="nav-text flex">
                <% if (typeof mostrar_voltar != "undefined" ? mostrar_voltar : false) { %>
                    <button type="button" id-projeto="<%=id_projeto%>" id-modulo="<%= id_modulo %>" class="voltar" onclick="back_to_main()">
            ...
            <div class="nav-wrapper">
                <div class="nav-text flex" style="width: 100%; max-width: 100%;">
                    <button type="button" class="voltar resetButtonStyle" onclick="change_view('back')"
                        ...
                        <i class="material-icons white-text" style="padding-left:20px">close</i>
                    </button>
                </div>
                <div class="nav-buttons">
        ...
        <nav class="nav-extended" style="box-shadow: none;">
            <div class="nav-wrapper">
                ...
                <!--<div class="nav-buttons">
                    ...
                    <i class="material-icons white-text" style="padding-right:20px">share</i>
            </div>
        </nav>
`;
