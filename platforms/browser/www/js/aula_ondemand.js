...
function load_aula_ondemand(aula_ondemand) {
    ...
    console.log("aulas1s",aula_ondemand.id_projeto, aulas, );
    ...
    // });
    render_menu_arquivos_ondemand(dados.material, aula_ondemand.id_aula);
...
function render_menu_arquivos_ondemand(material, id_aula){
    document.querySelector('#box_menu_arquivos_ondemand').innerHTML = ejs.render(new_menu_arquivos_ondemand, {
        arquivos: material,
        id_aula: id_aula
    });
  $(document).ready(function(){
    $('.menu-arquivos-ondemand .collapsible').collapsible();
    $('.menu-arquivos-ondemand .modal').modal({
      startingTop: 4
    });
  });
}